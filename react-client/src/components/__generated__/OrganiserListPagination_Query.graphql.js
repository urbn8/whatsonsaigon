/**
 * @flow
 * @relayHash 8befe680190e76e3a53c617d25591fba
 */
...
export type OrganiserListPagination_QueryResponse = {|
  +viewer: ?{| |};
|};
*/
...
const batch /*: ConcreteBatch*/ = {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "OrganiserListPagination_Query",
    "selections": [
      {
        "kind": "LinkedField",
        "alias": null,
  ...
  "text": "query OrganiserListPagination_Query(\n  $count: Int!\n  $cursor: String\n) {\n  viewer {\n    ...OrganiserList_viewer\n    id\n  }\n}\n\nfragment OrganiserList_viewer on User {\n  organisers(first: $count, after: $cursor) {\n    edges {\n      cursor\n      node {\n        ...Organiser_organiser\n        id\n        __typename\n      }\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n    }\n  }\n}\n\nfragment Organiser_organiser on Organiser {\n  id\n  name\n  slug\n}\n"
};
