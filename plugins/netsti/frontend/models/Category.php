...
use Model;
use URL;
use NetSTI\Frontend\Models\Post;
...
class Category extends Model{
	...
	public $table = 'netsti_frontend_categories';
	...
	public $rules = [
		...
		'slug' => 'required|between:3,64|unique:netsti_frontend_categories',
		'code' => 'unique:netsti_frontend_categories',
	];

	protected $guarded = [];

	public $belongsToMany = [
		'posts' => ['NetSTI\Frontend\Models\Article',
