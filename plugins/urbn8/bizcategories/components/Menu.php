...
class Menu extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'urbn8.bizcategories::lang.menu.name',
            'description' => 'urbn8.bizcategories::lang.menu.description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'start'            => [
                'description' => 'urbn8.bizcategories::lang.component.start.description',
                'title'       => 'urbn8.bizcategories::lang.component.start.title',
                'default'     => 1,
                'type'        => 'dropdown'
            ],
            'activeNode'       => [
                'description' => 'urbn8.bizcategories::lang.component.activenode.description',
                'title'       => 'urbn8.bizcategories::lang.component.activenode.title',
                'default'     => 0,
                'type'        => 'dropdown'
            ],
            'listItemClasses'  => [
                'description' => 'urbn8.bizcategories::lang.component.listitemclasses.description',
                'title'       => 'urbn8.bizcategories::lang.component.listitemclasses.title',
                'default'     => 'item',
                'type'        => 'string'
            ],
            'primaryClasses'   => [
                'description' => 'urbn8.bizcategories::lang.component.primaryclasses.description',
                'title'       => 'urbn8.bizcategories::lang.component.primaryclasses.title',
                'default'     => 'nav nav-pills',
                'type'        => 'string'
            ],
            'secondaryClasses' => [
                'description' => 'urbn8.bizcategories::lang.component.secondaryclasses.description',
                'title'       => 'urbn8.bizcategories::lang.component.secondaryclasses.title',
                'default'     => 'dropdown-menu',
                'type'        => 'string'
            ],
            'tertiaryClasses'  => [
                'description' => 'urbn8.bizcategories::lang.component.tertiaryclasses.description',
                'title'       => 'urbn8.bizcategories::lang.component.tertiaryclasses.title',
                'default'     => '',
                'type'        => 'string'
            ],
            'numberOfLevels'   => [
                'description' => 'urbn8.bizcategories::lang.component.numberoflevels.description',
                'title'       => 'urbn8.bizcategories::lang.component.numberoflevels.title',
